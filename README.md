...
```
or install manually if requirement file is failed:
```
...
- browser support
- operating system language packs installed system voices
...
## ⚠️ Troubleshooting
1. Assistant keeps thinking forever
